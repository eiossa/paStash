...
//  data.correlation = {a: "ciao", b: "prova"}
...
// TODO if plugin is videoroom
  ...
  //  data.correlation = "a";  //  QUA funziona
      ...
      //data.correlation = "c"; // qua NON funziona -> non c'è il campo correlation su ES
